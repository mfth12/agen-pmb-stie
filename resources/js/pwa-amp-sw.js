// 1. Dapatkan base URL dari window.location
const baseHref = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : "");
// 2. Update swsource menggunakan baseHref untuk membangun URL yang sesuai
const homeref = baseHref + "/js/pwa-sw.js";

const CACHE_VERSION = '1.7.69.5';

const BASE_CACHE_FILES = [
    homeref + '/wp-content/uploads/2024/04/simpeg-stie.png',
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    ...
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    homeref + '/wp-content/uploads/2024/04/akses-stie-logo.jpg',
    homeref + '/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
...
const OFFLINE_PAGE = homeref + '/?amp=1';
const NOT_FOUND_PAGE = homeref + '/?amp=1';
...
const CACHE_BLACKLIST = [
    //    (str) => {
    //        return !str.includes('/wp-admin/') || !str.startsWith(homeref + '//wp-admin/');
    //    },
];
