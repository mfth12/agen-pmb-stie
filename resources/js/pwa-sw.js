// 1. Dapatkan base URL dari self
const homeref = self.location.protocol + "//" + self.location.hostname + (self.location.port ? ":" + self.location.port : "");
const CACHE_VERSION = '1.7.69.8';

const BASE_CACHE_FILES = [
  homeref + '/logo-main.png',
  homeref + '/logo-main.png',
];
...
const OFFLINE_PAGE = homeref + '/';
const NOT_FOUND_PAGE = homeref + '/';
