                    ...
                    <div class="card-body">
                        <form action="{{ route('uploadsertifikat') }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('id_non') is-invalid @enderror" name="id_non" value="{{ old('id_non') }}" placeholder="">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nilai') is-invalid @enderror" name="nilai" value="{{ old('nilai') }}" placeholder="">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('lulus') is-invalid @enderror" name="lulus" value="{{ old('lulus') }}" placeholder="">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('no_sertifikat') is-invalid @enderror" name="no_sertifikat" value="" placeholder="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" class="form-control @error('file_sertifikat') is-invalid @enderror" name="file_sertifikat">
