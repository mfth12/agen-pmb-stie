...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
  <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    ...
    <div
      class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#800000] selection:text-white">
          ...
          <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                ...
                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                  ...
                  <div class="pt-3 sm:pt-5 lg:pt-0">
                    ...
                    <p class="mt-4 text-sm/relaxed">
                      Kegiatan Non Akademik akan banyak pilihan bagi mahasiswa: mulai dari mengikuti kegiatan dalam
                      ormawa, mengikuti pelatihan-pelatihan, seminar, workshop internal dan eksternal.
                    </p>
                  </div>
                </div>
            ...
            <a href="{{ route('nonakademiks.index') }}"
              ...
              <div class="pt-3 sm:pt-5">
                ...
                <p class="mt-4 text-sm/relaxed">
                  Kegiatan Non Akademik merupakan kegiatan yang juga diwajibkan bagi tiap mahasiswa dan terpisahkan dari
                  Kegiatan Akademik. Kegiatan Non Akademik ini dimulai ketika mahasiswa baru diterima menjadi mahasiswa
                  dengan mengikuti kegitan PKKMB.
                </p>
              </div>
            ...
            <a href="http:../transaknonakademiks"
              class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
              <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <g fill="#FF2D20">
              ...
              <div class="pt-3 sm:pt-5">
                ...
                <p class="mt-4 text-sm/relaxed">
                  Kegiatan non akademik yang dibuka oleh admin yang berwenang. Admin UPT membuka pelatihan-pelatihan
                  yang diadakan oleh UPT seperti: JASP, EVIEWs dan TOEFL. Waka 3 membuka PKKMB.
                </p>
              </div>
