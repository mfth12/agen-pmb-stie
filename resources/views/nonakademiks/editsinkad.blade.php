    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border-0 shadow-sm rounded">
          <div class="card-body">
            <form action="{{ route('nonakademiks.update', $nonakademik->id) }}" method="POST"
              ...
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('kegiatan') is-invalid @enderror" name="kegiatan"
                  value="{{ old('kegiatan', $nonakademik->kegiatan) }}" placeholder="">
                @error('kegiatan')
                  <div class="alert alert-danger mt-2">
                    {{ $message }}
                  </div>
                ...
                <div class="col-md-3">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('kategori') is-invalid @enderror" name="kategori"
                      value="{{ old('kategori', $nonakademik->kategori) }}" placeholder="">
                ...
                <div class="col-md-3">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('ta') is-invalid @enderror" name="ta"
                      value="{{ old('ta', $nonakademik->ta) }}" placeholder="">
                ...
                <div class="col-md-3">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('biaya') is-invalid @enderror" name="biaya"
                      value="{{ old('biaya', $nonakademik->biaya) }}" placeholder="">
