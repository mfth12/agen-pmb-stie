                ...
                @forelse ($nonakademiks as $nonakademik)
                  <tr>
                    ...
                    <td class="text-center">
                      <img src="{{ asset('storage/brosurs/' . $nonakademik->brosur) }}" class="rounded"
                        style="width: 150px">
                    </td>
                    ...
                    <td class="text-center">
                      <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                        action="{{ route('nonakademiks.destroy', $nonakademik->id) }}" method="POST">
                        <a href="{{ route('nonakademiks.show', $nonakademik->id) }}"
                          class="btn btn-sm btn-dark">Show</a>
                        <a href="{{ route('nonakademiks.edit', $nonakademik->id) }}"
