        ...
        <div class="row" id="data_row">
          <div class="col-lg-12">
            <div class="callout callout-default">
              Berikut adalah data potongan gaji pegawai
            </div>
            <div class="card">
              <div class="card-body">
                {{-- Tombol Atas --}}
                <div class="d-flex flex-wrap justify-content-between">
                  <div class="d-flex flex-wrap justify-content-lg-start">
                    <div class="form-group mr-2">
                      @if (request()->routeIs('potongan.index'))
                ...
                {{-- tabel --}}
                <table id="table_potongan" class="table table-hover">
                  <thead>
                    <tr>
...
@section('js_bawah')
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#table_potongan').DataTable({
        ...
        language: {
          ...
          "search": "Cari:",
          "emptyTable": "Tidak ada data potongan",
          "thousands": ".",
          "paginate": {
            "first": "Pertama",
            "last": "Terakhir",
      ...
      $.ajax({
        ...
        success: function(data) { //jika sukses
          setTimeout(function() {
            ...
            // var oTable = $('#table_potongan').dataTable();
    ...
    $(document).ajaxComplete(function(event, xhr, settings) {
      const $container = $('#table_potongan'); // Gantilah dengan selector tabel Anda
      stopLoadingWhenImagesLoaded($container);
    });
  </script>
@endsection
