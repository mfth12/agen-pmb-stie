        ...
        <div class="row" id="data_row">
          <div class="col-lg-12">
            <div class="callout callout-default">
              Berikut adalah data tunjangan gaji pegawai
            </div>
            <div class="card">
              <div class="card-body">
                {{-- Tombol Atas --}}
                <div class="d-flex flex-wrap justify-content-between">
                  <div class="d-flex flex-wrap justify-content-lg-start">
                    <div class="form-group mr-2">
                      @if (request()->routeIs('tunjangan.index'))
                ...
                {{-- tabel --}}
                <table id="table_tunjangan" class="table table-hover">
                  <thead>
                    <tr>
...
@section('js_bawah')
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#table_tunjangan').DataTable({
        ...
        ajax: {
          ...
          @elseif (request()->routeIs('tunjangan.filter'))
            url: "{{ route('tunjangan.filter') }}",
              // data: {
        ...
        language: {
          ...
          "search": "Cari:",
          "emptyTable": "Tidak ada data tunjangan",
          "thousands": ".",
          "paginate": {
            "first": "Pertama",
            "last": "Terakhir",
      ...
      $.ajax({
        ...
        success: function(data) { //jika sukses
          setTimeout(function() {
            ...
            // var oTable = $('#table_tunjangan').dataTable();
    ...
    $(document).ajaxComplete(function(event, xhr, settings) {
      const $container = $('#table_tunjangan'); // Gantilah dengan selector tabel Anda
      stopLoadingWhenImagesLoaded($container);
    });
  </script>
@endsection
