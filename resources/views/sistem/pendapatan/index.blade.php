  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="alert alert-hilang alert-warning alert-dismissible">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <i class="fa-solid fa-exclamation-triangle mr-2"></i><strong>Maaf!</strong>
              Modul belum dapat digunakan sepenuhnya
            </div>
          </div>
        </div>
        {{-- @endif --}}
            ...
            <a href="{{ route('gaji_pokok.index') }}">
              <div class="info-box" style="margin-bottom: 0.5rem; color: black">
                ...
                <div class="info-box-content" style="line-height: 1.3">
                  ...
                  <span class="info-box-number counter" data-target="51">
                    {{ 0 }}%</span>
                  <div class="progress">
            ...
            <a href="{{ route('potongan.index') }}">
              <div class="info-box" style="margin-bottom: 0.5rem; color: black">
                ...
                <div class="info-box-content" style="line-height: 1.3">
                  ...
                  <span class="info-box-number counter" data-target="70"> {{ floor(45 / 2) }}</span>
                </div>
              </div>
            </a>
          </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                  <div class="d-flex flex-wrap justify-content-lg-start">
                    <div class="form-group mr-2">
                      ...
                      @elseif (request()->routeIs('gaji.index'))
                        <a href="javascript:void(0)" class="btn btn-default" id="tombol-tambah">
                          Generate Gaji<i class="fa-solid fa-plus ml-1"></i>
                        </a>
                      @endif
                    </div>
                ...
                {{-- tabel --}}
                <table id="table_pendapatan" class="table table-hover">
                  <thead>
                    <tr>
...
@section('js_bawah')
  ...
  <script>
    ...
    $(document).ready(function() {
      @if (request()->routeIs('gaji.filter'))
      ...
      $('#table_pendapatan').DataTable({
        ...
        ajax: {
          ...
          @if (request()->routeIs('gaji.index'))
            url: "{{ route('gaji.index') }}",
          @elseif (request()->routeIs('gaji.filter'))
    ...
    $(document).ajaxComplete(function(event, xhr, settings) {
      const $container = $('#table_pendapatan'); // Gantilah dengan selector tabel Anda
      stopLoadingWhenImagesLoaded($container);
    });
  </script>
@endsection
