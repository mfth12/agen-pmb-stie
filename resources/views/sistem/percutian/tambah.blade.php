...
@section('container')
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container">
        <form enctype="multipart/form-data" action="{{ route('percutian.store_manual') }}" method="POST"
            ...
            <div class="col-md-8">
              <div class="card card-default">
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="col-md-6 col-xs-6">
                      <div class="form-group">
                        <label for="tanggal_cuti_awal">Cuti Tanggal</label>
                        <div class="input-group date" data-target-input="nearest">
                          <input type="text"
                            class="form-control datetimepicker-input @error('tanggal_cuti_awal') is-invalid @enderror"
                            data-target=" #tanggal_cuti_awal" id="tanggal_cuti_awal" name="tanggal_cuti_awal"
                            value="{{ old('tanggal_cuti_awal') }}" placeholder="yyyy-mm-dd" />
                          <div class="input-group-append" data-target="#tanggal_cuti_awal" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                          </div>
                        </div>
                        @error('tanggal_cuti_awal')
                          <div class="invalid-feedback">
                            *{{ $message }}
                          </div>
                        @enderror
                    ...
                    <div class="col-md-6 col-xs-6">
                      <div class="form-group">
                        <label for="tanggal_cuti_akhir">Sampai Tanggal</label>
                        <div class="input-group date" data-target-input="nearest">
                          <input type="text"
                            class="form-control datetimepicker-input @error('tanggal_cuti_akhir') is-invalid @enderror"
                            data-target=" #tanggal_cuti_akhir" id="tanggal_cuti_akhir" name="tanggal_cuti_akhir"
                            value="{{ old('tanggal_cuti_akhir') }}" placeholder="yyyy-mm-dd" />
                          <div class="input-group-append" data-target="#tanggal_cuti_akhir" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                          </div>
                        </div>
                        @error('tanggal_cuti_akhir')
                          <div class="invalid-feedback">
                            *{{ $message }}
                          </div>
                        @enderror
                  ...
                  <div class="form-group">
                    <label for="berapa_lama" class="control-label">Lama Cuti</label>
                    <input type="text" class="form-control @error('berapa_lama') is-invalid @enderror" id="berapa_lama"
                      ...
                      placeholder="Lama cuti dalam kalimat (Misal: 3 hari)">
                    @error('berapa_lama')
                      <div class="invalid-feedback">
                        *{{ $message }}
                      </div>
                  ...
                  <div class="form-group">
                    <label for="kategori_cuti" class="control-label">Kategori Cuti</label>
                    <select class="form-control" name="kategori_cuti">
                      <option value="" @empty(old('kategori_cuti')) selected @endempty>-- Pilih Kategori --
                      </option>
                      @foreach ($kateg_cuti as $item)
                        <option value="{{ $item->kateg_cuti_id }}">{{ $item->jenis_cuti }}</option>
                      @endforeach
                    </select>
                    @error('kategori_cuti')
                      <div class="invalid-feedback">
                  ...
                  <div class="form-row">
                    <div class="col-md-7 col-xs-7">
                      <div class="form-group @error('keperluan_cuti') is-invalid @enderror">
                        <label for="keperluan_cuti" class="control-label">Keperluan</label>
                        <textarea class="form-control" name="keperluan_cuti" id="keperluan_cuti" value="{{ old('keperluan_cuti') }}"
                          rows="4" placeholder="Deskripsikan keperluan mengajukan cuti"></textarea>
                      </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-12">
                        <small>
                          <label class="form-check-label">Catatan: Formulir pengajuan cuti ini harus diverifikasi oleh <a
                              href="javascript:void(0)">Atasan</a> Anda dan disetujui oleh <a
                              href="javascript:void(0)">Wakil Ketua II</a>.</label>
                        </small>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" id="tombol-simpan" class="btn btn-success float-right">Kirim
    ...
    $(function() {
      $("form[name='percutian_create']").validate({
        ...
        messages: {
          ...
          kategori_cuti: {
            required: "Kategori cuti harus dipilih.",
          },
          keperluan_cuti: {
        ...
        submitHandler: function(form) {
          var tanggalIzinAwal = $('#tanggal_cuti_awal').val();
          var tanggalIzinAkhir = $('#tanggal_cuti_akhir').val();
          ...
          if (tanggalIzinAwal > tanggalIzinAkhir) {
            ...
            $('#tanggal_cuti_awal').addClass('is-invalid');
            $('#tanggal_cuti_akhir').addClass('is-invalid');
            return;
          }
          ...
          // $.ajax({
          //   data: $('#percutian_create').serialize(),
          //   url: "{{ route('perizinan.store_manual') }}",
          //   type: "POST",
          //   dataType: 'json',
          //   success: function(data) {
          //     $('#percutian_create').trigger("reset");
          //     // $('#tambah-edit-modal').modal('hide');
          //     $('#tombol-simpan').html('Ajukan');
          //     iziToast.success({
          //       title: `Ok`,
          //       message: `Formulir cuti berhasil diajukan.`,
          //       position: `topCenter`
          //     });
          //   },
          //   error: function(data) {
